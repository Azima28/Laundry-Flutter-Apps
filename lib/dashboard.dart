  ...
  class DashboardPage extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
      return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Kasir Laundry', style: TextStyle(color: Colors.white)),
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        label: const Text('Pesan Laundry', style: TextStyle(fontSize: 16, color: Colors.white)),
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        icon: const Icon(Icons.iron, color: Colors.white,),
                        label: const Text('Pesan Gosok', style: TextStyle(fontSize: 16, color: Colors.white)),
